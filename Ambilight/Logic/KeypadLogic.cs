...
namespace Ambilight.Logic
{
    ...
    class KeypadLogic : IDeviceLogic
    {
        ...
        {
            Bitmap resizedMap = ImageManipulation.ResizeImage(newImage, KeypadConstants.MaxColumns, KeypadConstants.MaxRows, _settings.UltrawideModeEnabled);
        ...
        /// <summary>
        /// From a given resized screenshot, an ambilight effect will be created for the keypad
        /// </summary>
            ...
            using (var fastBitmap = new FastBitmap(map))
            {
                ...
                for (var r = 0; r < KeypadConstants.MaxRows; r++)
                {
                    for (var c = 0; c < KeypadConstants.MaxColumns; c++)
                    {
                        ...
                        {
                            color = fastBitmap.GetPixel(c, KeypadConstants.MaxRows - 1);
                        }
                        else
                        {
